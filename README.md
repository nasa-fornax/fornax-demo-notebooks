...
This repo houses tutorial notebooks of fully worked science use cases for all users.  
...
Currently, there are two major topics for which we have notebooks.  
...
If you already have an ``ipynb`` file (called yournotebook.ipynb in this example), convert it to Markdown using the following command, and commit only the markdown file to the repo:
