...
OBJ_PRESETS = {"crab": {'start_red_int_perc': 85.,
               ...
               "m61": {'start_red_int_perc': 95.,
                       ...
                       'start_q': 4.,
                       'start_stretch': 1.5},
               "SN1604": {'start_red_int_perc': 99.,
                          'start_green_int_perc': 99.5,
                          'start_blue_int_perc': 99.5,
                          'start_q': 2.6,
                          'start_stretch': 0.5},
               "zwcl0024+1652": {'start_red_int_perc': 98.5,
                          'start_green_int_perc': 98.5,
                          'start_blue_int_perc': 97.,
                          'start_q': 4.5,
                          'start_stretch': 1.2},
               "a370": {'start_red_int_perc': 97.,
                         'start_green_int_perc': 96.5,
                         'start_blue_int_perc': 93.,
                         'start_q': 4.0,
                         'start_stretch': 1.4},
               "ic5201": {'start_red_int_perc': 96.,
                         'start_green_int_perc': 97.,
                         'start_blue_int_perc': 99.,
                         'start_q': 2.1,
                         'start_stretch': 1.1}
               }
